...
export const BentoGridItem = ({
  ...
  const handleCopy=()=>{
    navigator.clipboard.writeText('bajajaditi1122@gmail.com');
    Setcopied(true);
  }
  return (
    <div
      ...
      <div className={`${id === 6 && 'flex justify-center'} h-full`}>
        ...
        {id === 6 && (
          <BackgroundGradientAnimation>
            {/*<div className="absolute z-50 inset-0  flex items-center justify-center text-white font-bold text-center" />*/}
          </BackgroundGradientAnimation>
        )}
        <div className={cn(
          ...
          {id === 3 && (
            ...
            <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
              {['Express.js', 'react.js', 'MongoDB'].map((item) => (
                <span key={item} className="lg:py-4 lg:px-3 py-2 px-3 text-xs lg:text-base opacity-50 
                    lg:opacity-100 rounded-lg text-center bg-[#10132E]">
                  {item}
                </span>
