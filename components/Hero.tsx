...
import { Spotlight } from './ui/Spotlight';
 import { TextGenerateEffect } from './ui/TextGenerateEffect'; // Removed since it's no longer used
    ...
    <div className='pb-20 pt-36 relative' id='about'>
      ...
      <div className='flex flex-col md:flex-row justify-center items-center relative my-20 z-10 max-w-7xl mx-auto'>
        ...
        <div className='flex-shrink-0 mb-10 md:mb-0 md:mr-10'>
          <img 
            src="about.jpg"  // Update with the path to your image
            alt="Aditi Bajaj"
            className='w-80 h-80 rounded-full object-cover shadow-lg mb-20 mr-10'
          />
        </div>
        ...
        <div className='flex flex-col items-center md:items-start max-w-xl text-center md:text-left'>
          ...
          <TextGenerateEffect className="text-[30px] md:text-3xl lg:text-4xl font-bold mb-4"
           words=' Hy, I&apos;m Aditi Bajaj'/>
          
          <p className='text-sm md:text-lg lg:text-1xl  mb-5'>
